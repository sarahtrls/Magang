...
class Daftar extends CI_Controller {
	...
	{
		//pagination
		$config['base_url'] = 'http://localhost/webgis/index.php/daftar/index';
		...
		$datacontent['url']='Daftar Satwa';
		$datacontent['title']='Daftar Satwa';
		...
		// $datacontent['datatable']=$this->DatasatwaModel->get();
		$data['content']=$this->load->view('layoutuser/listUser',$datacontent,TRUE);
		// $data['js']=$this->load->view('peta/js/mapjs',$datacontent,TRUE);
		$data['title']=$datacontent['title'];
		$this->load->view('layoutuser/htmlList',$data);
	}
}
